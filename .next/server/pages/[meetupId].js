...
function _meetupId_meetupId(props) {
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://test:123@cluster0.ytg5u.mongodb.net/meetups?retryWrites=true&w=majority");
  const db = client.db();
...
/* harmony default export */ var _meetupId_ = __webpack_exports__["default"] = (_meetupId_meetupId);
